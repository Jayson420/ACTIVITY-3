    ...
    <View style={{ flex: 1, justifyContent: "center", paddingHorizontal: 20 }}>
      ...
      >
        {({
          ...
          return (
            <View styles={{ flex: 1 }}>
              <Text variant="displaySmall" style= {{backgroundColor: '#2eb5e8', borderRadius: 10, padding: 20, color: 'white', marginBottom: 5}}>Welcome Back</Text>
              <Text style={{ fontWeight: "bold", color: "#2eb5e8" }}>
              ...
              <Card.Actions>
                <Button
                  ...
                  icon="account-plus"
                  mode="contained"
                  style={{ marginTop: 10, backgroundColor: '#32c2f8' }}
